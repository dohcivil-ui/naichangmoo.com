...
> ช่องว่างที่บันทึกไว้ตรง ๆ: v0.36.0 ไม่มีไฟล์รุ่นอยู่ในที่เก็บ จึงไม่มี entry และไม่ปักธงให้ ส่วน v0.41.0 ถึง v0.44.0 ไฟล์รุ่นทั้งสี่ถูกสร้างใน commit เดียวกัน สี่รุ่นนี้จึงไม่มีจุดย้อนกลับแยกกัน ปักธงให้เฉพาะ v0.44.0 ที่ commit นั้น
