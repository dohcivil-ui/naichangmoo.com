...
## คู่มือสำหรับเจ้าของงาน (ไฟล์ HTML เปิดดูได้)

สามไฟล์นี้เป็น**สื่อการสอนและห้องทดลอง ไม่ใช่แหล่งอ้างอิง** เมื่อเนื้อหาขัดกับไฟล์นี้ให้ยึดไฟล์นี้
ทั้งสามเปิดด้วยการดับเบิลคลิกที่ไฟล์ได้เลย ไม่ต้องรัน dev server และไม่ต้องต่อเน็ตยกเว้นเรื่องฟอนต์

| ไฟล์ | เนื้อหา |
|---|---|
| `.design/ui-guide/ui-system-guide.html` | สี่เรื่องพื้นฐาน — สี · ส่วนประกอบหน้าจอ · การเคลื่อนไหว · หน้าเว็บแบบ SaaS พร้อมตัวเลขคอนทราสต์จริงของกระปุกสีเรา |
| `.design/landing-motion/component-lab.html` | ห้องเครื่องมือ ส่วนประกอบ 21 ตัว ถอดจาก Velora UI มาใส่สีเรา ทุกตัวกดได้และเคลื่อนไหวจริง |
| `.design/landing-motion/motion-demos.html` | ลูกเล่นเคลื่อนไหวห้าตัวแรกที่คัดมาก่อน เป็นชุดย่อยของห้องเครื่องมือ |

ชื่อของแต่ละตำแหน่งบนหน้าแรกอยู่ที่ `src/lib/landing-blocks.ts` ไม่ใช่ในไฟล์เหล่านี้
