 ...
 *
 * **ใช้ `system` และ `schema` ชุดที่ผ่านการวัดด้วยโจทย์จริงมาแล้ว**
 ...
 *
 * ไฟล์นี้เพิ่มสิ่งที่เส้นทางเก่าไม่มีสามอย่าง: ตัดข้อมูลส่วนเกินก่อนเข้า prompt · ส่งข้อเท็จจริงผ่าน
 * บล็อกที่คั่นชัดเจน · และประกาศว่าคำตอบไหลเข้าการคำนวณต่อหรือไม่ — ตั้งแต่ IP-184
 * หน้าจอ work-plan เรียกผ่านประตูกลางทางนี้แล้ว เส้นทางเก่า (work-plan-assistant.ts) ถูกลบทิ้ง
 */
