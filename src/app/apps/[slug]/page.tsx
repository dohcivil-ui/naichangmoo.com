      ...
      <AppShell app={app}>
        <section className="app-workspace-intro">
          <div className="container">
            ...
            <div className="hero__actions"><SignInButton /><Link className="button button--orange micro-button" href={landingActionContract.allAppsHref}>{landingActionContract.allAppsLabel}</Link></div>
          </div>
        </section>
      </AppShell>
    );
