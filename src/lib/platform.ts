...
export const platformApps: PlatformApp[] = [
  ...
  },
  {
    ...
    /* ค่า K ไปได้สองทาง และคำโฆษณาชุดเดิมเขียนไว้ทางเดียว — พูดถึงแต่เงินที่ได้รับ
       ทั้งที่ตาม ว 109 เมื่อดัชนีลงจนหลุดกรอบด้านล่าง ผู้รับจ้างต้องคืนเงินให้รัฐ
       คนที่อ่านหน้าขายจะเข้าใจว่าแอปนี้มีไว้หาเงินเพิ่มอย่างเดียว ทั้งที่เหตุผลที่ต้องคำนวณ
       คือยังไม่รู้ว่าจะได้หรือจะเสีย · เจ้าของงานทักเอง 2026-09-06 แล้วเคาะให้แก้ทั้งสามช่อง
       พร้อมกัน เพราะเป็นคำโฆษณาสาธารณะที่ ADR 0018 ย้ายเข้าทะเบียน */
    description: "คำนวณค่า K ว่าต้องคืนเงินหลวง หรือได้เงินเพิ่ม",
    programName: "แอปคำนวณค่า K งานก่อสร้าง",
    purpose:
      "สำหรับคำนวณค่า K ของสัญญาแบบปรับราคาได้ (Escalation Factor) ตามมติคณะรัฐมนตรี ว 109 ว่างวดนี้ผู้รับจ้างได้เงินเพิ่ม หรือต้องคืนเงินให้รัฐ",
    ...
    categoryId: "building-cost",
    marketDetail: {
      outcome: "คำนวณค่า K แล้วรู้ว่างวดนี้ได้เงินเพิ่ม หรือต้องคืนเงินหลวง",
