 ...
 * คิดที่ระดับกิจกรรม ไม่ใช่ที่ระดับปฏิทิน เพราะฝนไม่ได้ทำให้วันนั้นทำงานไม่ได้ทั้งวันเสมอไป
 * มันทำให้งานเสร็จช้าลง ซึ่งเป็นคนละเรื่องกับวันหยุดที่ทำงานไม่ได้จริง
 *
