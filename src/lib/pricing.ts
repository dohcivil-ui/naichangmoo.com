...
export const pricingTiers: readonly PricingTier[] = [
  {
    ...
    name: "ทดลองใช้ฟรี",
    summary: "ลองถอดปริมาณและประมาณราคาจากแบบจริงของคุณ ก่อนตัดสินใจสมัคร",
    price: { kind: "free_for_days", days: ESTIMETR_TRIAL_DAYS },
    highlights: [
      "นับ 7 วันจากวันที่กดเริ่มใช้งาน",
      "ถอดปริมาณพร้อมบันทึกที่มาของการวัดจากแบบ",
      "ครบกำหนดแล้ว ข้อมูลเดิมยังเปิดดูได้"
    ],
    cta: { label: "เริ่มทดลองใช้ฟรี", href: "/market/estimeter" },
    state: "trial",
    featured: false
  },
  {
  ...
  },
  {
    ...
    highlights: [
      ...
      "แบบฟอร์มนี้เป็นการรับรายละเอียดงาน ทีมงานติดต่อกลับก่อนออกใบเสนอราคา"
    ],
