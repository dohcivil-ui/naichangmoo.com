...
const NUMERIC_COLUMNS = [
  ...
  ".mk__num",
  ".mk__tour-num",
  /* ช่องตัวเลขทั้งหมดของหน้าแรกรุ่นสาม — นาฬิกานับถอยหลัง ราคา เบอร์โทร และเลขกลุ่มงาน
     ต่างจากตัวอื่นในรายการนี้ตรงที่มันเป็นช่องเดียวที่ใช้ซ้ำทุกที่ แทนที่จะมีคลาสต่อจุด
     ถ้าวันไหนมีคนลบกฎที่ผูก `--font-numeric` ให้มันในครัวกลาง ทั้งสี่อย่างจะหลุดกลับไปเป็น
     ฟอนต์หลักพร้อมกันโดยไม่มีอะไรแดง ซึ่งเป็นบั๊กพันธุ์เดียวกับที่ทำให้ด่านนี้เกิดขึ้นมา */
  ".v3-hd"
];
...
const THAI_WORD_SLOTS = [
  ...
  /* คำไทยที่นั่งในช่องตัวเลขของหน้าแรกรุ่นสาม — หน่วยท้ายราคาอย่าง "/ เดือน"
     และคำกำกับในแถวราคา ซึ่งไม่มีหลักให้เรียงจึงไม่ควรถูกฟอนต์ตัวเลขลากไปด้วย */
  ".v3-hd small",
  ".v3-hd em"
];
