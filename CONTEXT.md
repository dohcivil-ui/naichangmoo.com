...
**Document Set**:
ชุดแบบฟอร์มราชการที่จบในตัวเองหนึ่งชุด มี ปร.4 ปร.5 และ ปร.6 เป็นของชุดนั้นเอง โดย ปร.6 ของชุดคือราคาสุดท้ายของชุดนั้นและปัดเศษของตัวเอง revision เดียวออกได้มากกว่าหนึ่งชุด เช่น ชุดงานก่อสร้างกับชุดครุภัณฑ์จัดซื้อ ที่แยกกันเพราะคิดเลขคนละวิธี แต่อยู่ในโครงการและการอนุมัติเดียวกัน.
